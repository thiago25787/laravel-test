...
Route::prefix('deposit')->group(function () {
    ...
    Route::post('/store/{account}', [App\Http\Controllers\DepositController::class, 'store'])->name('deposit.store')->where(['account' => '[0-9]+']);
...
Route::prefix('purchase')->group(function () {
    ...
    Route::post('/store/{account}', [App\Http\Controllers\PurchaseController::class, 'store'])->name('purchase.store')->where(['account' => '[0-9]+']);
});
